...
export const Alarm = ({ color = '#25282A', ...rest }: IconProps) => {
  return (
    <svg
      ...
      width="40"
    >
      <path d="M19.958 36.625q-3.083 0-5.812-1.187-2.729-1.188-4.75-3.209t-3.208-4.75Q5 24.75 5 21.625q0-3.083 1.188-5.812 1.187-2.73 3.208-4.771Q11.417 9 14.146 7.833q2.729-1.166 5.812-1.166 3.125 0 5.854 1.166 2.73 1.167 4.75 3.209 2.021 2.041 3.209 4.771 1.187 2.729 1.187 5.812 0 3.125-1.187 5.854-1.188 2.729-3.209 4.75-2.02 2.021-4.75 3.209-2.729 1.187-5.854 1.187Zm4.917-8.125 1.958-1.958-5.375-5.375v-7.834h-2.791v8.959ZM9.042 3.875 11 5.833l-6.917 6.75-1.958-1.958Zm21.833 0 6.917 6.75-1.917 1.958-6.917-6.75Z" />
    </svg>
  );
};
...
export const Stats = ({ color = '#25282A', ...rest }: IconProps) => {
  return (
    <svg
      ...
      width="40"
    >
      <path d="M11.792 28.417h2.75V16.875h-2.75Zm6.833 0h2.75V11.583h-2.75Zm6.833 0h2.75v-6.334h-2.75ZM7.792 35q-1.125 0-1.959-.833Q5 33.333 5 32.208V7.792q0-1.125.833-1.959Q6.667 5 7.792 5h24.416q1.125 0 1.959.833.833.834.833 1.959v24.416q0 1.125-.833 1.959-.834.833-1.959.833Z" />
    </svg>
  );
};
...
export const Inbox = ({ color = '#25282A', ...rest }: IconProps) => {
  return (
    <svg
      ...
      width="40"
    >
      <path d="M7.792 35q-1.125 0-1.959-.833Q5 33.333 5 32.208V7.792q0-1.125.833-1.959Q6.667 5 7.792 5h24.416q1.125 0 1.959.833.833.834.833 1.959v24.416q0 1.125-.833 1.959-.834.833-1.959.833ZM20 27.417q1.667 0 3.021-.959Q24.375 25.5 25.167 24h7.041V7.792H7.792V24h7.041q.792 1.5 2.146 2.458 1.354.959 3.021.959Z" />
    </svg>
  );
};

export const WifiLow = ({ color = '#25282A', ...rest }: IconProps) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height="24"
      ...
      width="24"
    >
      <path d="M480 936 360.54 815.925q23.154-23.154 53.576-36.154 30.423-13 65.884-13t65.884 13q30.422 13 53.576 36.154L480 936Z" />
    </svg>
  );
};

export const WifiMid = ({ color = '#25282A', ...rest }: IconProps) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height="24"
      ...
      width="24"
    >
      <path d="m254 710-62.46-63.691q55.538-55.538 129.269-87.538 73.73-32 159.191-32t159.191 32.308q73.731 32.307 129.269 88.461L706 710q-44-44-102-69t-124-25q-66 0-124 25t-102 69Zm226 226 119.46-120.075q-23.154-23.154-53.576-36.154-30.423-13-65.884-13t-65.884 13q-30.422 13-53.576 36.154L480 936Z" />
    </svg>
  );
};

export const WifiHigh = ({ color = '#25282A', ...rest }: IconProps) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height="24"
