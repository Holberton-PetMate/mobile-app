...
export const ChevronRight = ({ color = "#25282A", ...rest }: IconProps) => {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" fill={color} height="24" viewBox="0 96 960 960" width="24"><path d="m376 816-56-56 184-184-184-184 56-56 240 240-240 240Z" /></svg>
	);
};
